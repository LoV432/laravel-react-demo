                            ...
                            <Link
                                ...
                                className={
                                    link.active
                                        ...
                                        : "relative inline-flex items-center px-4 py-2 text-sm font-semibold text-white hover:text-black ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
                                }
